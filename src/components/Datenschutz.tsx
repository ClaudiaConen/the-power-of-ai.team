  ...
  return (
    <div className="legal-page">
      <div className="legal-header">
        <a href="#" className="legal-back" onClick={(e) => { e.preventDefault(); window.location.hash = ''; }}>
          <ArrowLeft size={16} />
          <span>Zurück zur Startseite</span>
        </a>
        <div className="legal-brand" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <img src="/THE_POWER_OF.png" alt="The Power of AI" className="nav-logo" />
          <span className="nav-n">Power <em>Upgrade</em></span>
        </div>
      </div>
      <div className="legal-content">
        <div className="lbl">Rechtliches<span></span></div>
        <h1 className="sh2" style={{ marginBottom: 32 }}>Datenschutzerklärung</h1>
        ...
        <h3>Netlify</h3>
        <p>
          Wir hosten unsere Website bei Netlify. Anbieter ist die Netlify, Inc., 512 2nd Street, Suite 200,
          San Francisco, CA 94107, USA (nachfolgend „Netlify").
        </p>
        <p>
          Wenn Sie unsere Website besuchen, werden Ihre personenbezogenen Daten auf den Servern von Netlify
          verarbeitet. Hierbei können auch personenbezogene Daten an den Mutterkonzern von Netlify in die USA
          übermittelt werden. Die Datenübertragung in die USA wird auf die EU-Standardvertragsklauseln gestützt.
          Details finden Sie hier:{' '}
          <a href="https://www.netlify.com/gdpr-ccpa" target="_blank" rel="noopener noreferrer">https://www.netlify.com/gdpr-ccpa</a>.
        </p>
        <p>
        ...
        <p>
          Weitere Informationen zu Datenschutz bei Netlify finden Sie unter:{' '}
        ...
        <p>
          ...
          sofern einer der folgenden Gründe zutrifft: Die personenbezogenen Daten sind für die Zwecke, für die sie
          erhoben oder auf sonstige Weise verarbeitet wurden, nicht mehr notwendig; Sie widerrufen Ihre
          Einwilligung und es fehlt an einer anderweitigen Rechtsgrundlage für die Verarbeitung; Sie legen
        ...
        <p>
          Der Provider der Seiten (Netlify) erhebt und speichert automatisch Informationen in so genannten
        ...
        <p>
          ...
          hierzu müssen die Server-Log-Dateien erfasst werden. Die Daten werden nach spätestens 30 Tagen
        ...
        <p>
          ...
          bestimmter, von Ihnen erwünschter Funktionen erforderlich sind (z. B. Warenkorbfunktion), werden auf
          Grundlage von Art. 6 Abs. 1 lit. f DSGVO bzw. § 25 Abs. 2 TDDDG gespeichert, sofern keine andere
          Rechtsgrundlage angegeben wird. Der Websitebetreiber hat ein berechtigtes Interesse an der Speicherung
          von technisch notwendigen Cookies zur technisch fehlerfreien und optimierten Bereitstellung seiner
          Dienste.
        </p>
        <p>
        ...
        <p>
          Die von Ihnen an uns per E-Mail gesendeten Daten verbleiben bei uns, bis Sie uns zur Löschung auffordern,
        ...
        <h3>Supabase</h3>
        <p>
          Wir nutzen den Dienst Supabase zur Speicherung und Verarbeitung von Kontaktformulardaten. Anbieter
          ist die Supabase, Inc., 970 Toa Payoh North #07-04, Singapore 318992. Die Daten werden auf Servern
          innerhalb der EU verarbeitet.
        </p>
        <p>
          Die Nutzung von Supabase erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein
          berechtigtes Interesse an einer zuverlässigen und sicheren Speicherung der über das Kontaktformular
          übermittelten Daten.
        </p>
        ...
        <p>
          ...
          dem Nutzer die Inanspruchnahme des Dienstes zu ermöglichen oder abzurechnen. Rechtsgrundlage hierfür ist
        ...
        <p>
          Für die Kommunikation mit unseren Kunden setzen wir unter anderen Online-Konferenz-Tools ein.
          Die im Einzelnen von uns genutzten Tools sind unten aufgelistet. Wenn Sie mit uns per Video- oder
          Audiokonferenz über das Internet kommunizieren, werden Ihre personenbezogenen Daten von uns und dem
        ...
        <p>
          ...
          oder bestimmte Leistungen gegenüber unseren Kunden anzubieten (Art. 6 Abs. 1 lit. b DSGVO). Des
          Weiteren dient der Einsatz der Konferenz-Tools der allgemeinen Vereinfachung und Beschleunigung der
          Kommunikation mit uns bzw. unserem Unternehmen (berechtigtes Interesse im Sinne von Art. 6 Abs. 1
          lit. f DSGVO).
        </p>

        <h3>Zoom</h3>
        <p>
          Wir nutzen Zoom. Anbieter dieses Dienstes ist die Zoom Video Communications, Inc., 55 Almaden
          Boulevard, 6th Floor, San Jose, CA 95113, USA. Details zur Datenverarbeitung entnehmen Sie der
          Datenschutzerklärung von Zoom:{' '}
          <a href="https://explore.zoom.us/de/privacy/" target="_blank" rel="noopener noreferrer">https://explore.zoom.us/de/privacy/</a>.
        </p>
        <p>
          Die Datenübertragung in die USA wird auf die EU-Standardvertragsklauseln gestützt. Details finden Sie
          hier:{' '}
          <a href="https://explore.zoom.us/de/privacy/" target="_blank" rel="noopener noreferrer">https://explore.zoom.us/de/privacy/</a>.
        </p>

        <h2>8. Geltungsbereich</h2>
        <p>
          Diese Datenschutzerklärung gilt für die Nutzung unserer Website und Dienstleistungen im Geltungsraum
          Deutschland, Österreich und der Schweiz.
        </p>

        <h3>Google Web Fonts (lokales Hosting)</h3>
        <p>
          Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Web Fonts. Die Google Fonts
          sind lokal installiert. Eine Verbindung zu Servern von Google findet dabei nicht statt.
        </p>
        <p>
      ...
      <footer className="foot">
        ...
        <span>
          <a href="#impressum">Impressum</a> · <a href="#datenschutz">Datenschutz</a> · claudiaconen.com
        </span>
