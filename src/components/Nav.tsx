const WA_URL = 'https://wa.me/4916093102073?text=Hallo%20Claudia%2C%20das%20will%20ich%20nicht%20verpassen!';
    ...
    <nav id="nav">
      ...
      <div className="nav-r">
        ...
        >
          ...
          <span className="nav-wa-txt">
            <span className="nav-wa-hook">Das willst du nicht verpassen</span>
            <span className="nav-wa-sub">Schreib mir ganz persönlich</span>
          </span>
          <span className="nav-wa-pulse" />
        </a>
        <a href="#community">Community</a>
        <a href="#kontakt">Kontakt</a>
        <a href="#angebote" className="nav-cta nav-cta--gold">Angebote entdecken</a>
        <a href="#kontakt" className="nav-cta">Persönlich anfragen</a>
      </div>
    </nav>
  );
}
